...
function createWasm() {
  ...
  function receiveInstance(instance, module) {
    ...
    wasmTable = wasmExports["Hi"];
    addOnInit(wasmExports["Ci"]);
...
var PokiSdk = {
  ...
  _shareableURLCallback: function _shareableURLCallback(url) {
    ...
    getWasmTableEntry(PokiSdk._urlCallback)(_url, url_arr.length);
    Module._free(_url);
  }
};
...
var wasmImports = {
  ...
  vi: _PokiSdkJs_IsAdBlocked,
  ui: _PokiSdkJs_RewardedBreak,
  ti: _PokiSdkJs_SetDebug,
  si: _PokiSdkJs_ShareableURL,
  b: ___assert_fail,
  ri: ___syscall__newselect,
  qi: ___syscall_accept4,
  pi: ___syscall_bind,
  oi: ___syscall_connect,
  ni: ___syscall_dup3,
  g: ___syscall_fcntl64,
  mi: ___syscall_getpeername,
  li: ___syscall_getsockname,
  ba: ___syscall_getsockopt,
  ki: ___syscall_ioctl,
  ji: ___syscall_listen,
  ii: ___syscall_mkdirat,
  aa: ___syscall_openat,
  hi: ___syscall_poll,
  gi: ___syscall_readlinkat,
  fi: ___syscall_recvfrom,
  ei: ___syscall_renameat,
  di: ___syscall_rmdir,
  ci: ___syscall_sendto,
  Aa: ___syscall_socket,
  bi: ___syscall_stat64,
  $: ___syscall_unlinkat,
  _h: __emscripten_get_now_is_monotonic,
  ...
  zh: _emscripten_glBindRenderbuffer,
  yh: _emscripten_glBindSampler,
  xh: _emscripten_glBindTexture,
  wh: _emscripten_glBindTransformFeedback,
  vh: _emscripten_glBindVertexArray,
  uh: _emscripten_glBindVertexArrayOES,
  th: _emscripten_glBlendColor,
  sh: _emscripten_glBlendEquation,
  rh: _emscripten_glBlendEquationSeparate,
  qh: _emscripten_glBlendFunc,
  ph: _emscripten_glBlendFuncSeparate,
  oh: _emscripten_glBlitFramebuffer,
  nh: _emscripten_glBufferData,
  mh: _emscripten_glBufferSubData,
  lh: _emscripten_glCheckFramebufferStatus,
  kh: _emscripten_glClear,
  jh: _emscripten_glClearBufferfi,
  ih: _emscripten_glClearBufferfv,
  hh: _emscripten_glClearBufferiv,
  gh: _emscripten_glClearBufferuiv,
  fh: _emscripten_glClearColor,
  eh: _emscripten_glClearDepthf,
  dh: _emscripten_glClearStencil,
  ch: _emscripten_glClientWaitSync,
  bh: _emscripten_glColorMask,
  ah: _emscripten_glCompileShader,
  $g: _emscripten_glCompressedTexImage2D,
  _g: _emscripten_glCompressedTexImage3D,
  ...
  zg: _emscripten_glDisable,
  yg: _emscripten_glDisableVertexAttribArray,
  xg: _emscripten_glDrawArrays,
  wg: _emscripten_glDrawArraysInstanced,
  vg: _emscripten_glDrawArraysInstancedANGLE,
  ug: _emscripten_glDrawArraysInstancedARB,
  tg: _emscripten_glDrawArraysInstancedEXT,
  sg: _emscripten_glDrawArraysInstancedNV,
  rg: _emscripten_glDrawBuffers,
  qg: _emscripten_glDrawBuffersEXT,
  pg: _emscripten_glDrawBuffersWEBGL,
  og: _emscripten_glDrawElements,
  ng: _emscripten_glDrawElementsInstanced,
  mg: _emscripten_glDrawElementsInstancedANGLE,
  lg: _emscripten_glDrawElementsInstancedARB,
  kg: _emscripten_glDrawElementsInstancedEXT,
  jg: _emscripten_glDrawElementsInstancedNV,
  ig: _emscripten_glDrawRangeElements,
  hg: _emscripten_glEnable,
  gg: _emscripten_glEnableVertexAttribArray,
  fg: _emscripten_glEndQuery,
  eg: _emscripten_glEndQueryEXT,
  dg: _emscripten_glEndTransformFeedback,
  cg: _emscripten_glFenceSync,
  bg: _emscripten_glFinish,
  ag: _emscripten_glFlush,
  $f: _emscripten_glFramebufferRenderbuffer,
  _f: _emscripten_glFramebufferTexture2D,
  ...
  If: _emscripten_glGetActiveUniformsiv,
  ...
  yf: _emscripten_glGetInteger64i_v,
  xf: _emscripten_glGetInteger64v,
  wf: _emscripten_glGetIntegeri_v,
  vf: _emscripten_glGetIntegerv,
  uf: _emscripten_glGetInternalformativ,
  tf: _emscripten_glGetProgramBinary,
  sf: _emscripten_glGetProgramInfoLog,
  rf: _emscripten_glGetProgramiv,
  qf: _emscripten_glGetQueryObjecti64vEXT,
  pf: _emscripten_glGetQueryObjectivEXT,
  of: _emscripten_glGetQueryObjectui64vEXT,
  nf: _emscripten_glGetQueryObjectuiv,
  mf: _emscripten_glGetQueryObjectuivEXT,
  lf: _emscripten_glGetQueryiv,
  kf: _emscripten_glGetQueryivEXT,
  jf: _emscripten_glGetRenderbufferParameteriv,
  hf: _emscripten_glGetSamplerParameterfv,
  gf: _emscripten_glGetSamplerParameteriv,
  ff: _emscripten_glGetShaderInfoLog,
  ef: _emscripten_glGetShaderPrecisionFormat,
  df: _emscripten_glGetShaderSource,
  cf: _emscripten_glGetShaderiv,
  bf: _emscripten_glGetString,
  af: _emscripten_glGetStringi,
  $e: _emscripten_glGetSynciv,
  _e: _emscripten_glGetTexParameterfv,
  ...
  ze: _emscripten_glIsTexture,
  ye: _emscripten_glIsTransformFeedback,
  xe: _emscripten_glIsVertexArray,
  we: _emscripten_glIsVertexArrayOES,
  ve: _emscripten_glLineWidth,
  ue: _emscripten_glLinkProgram,
  te: _emscripten_glPauseTransformFeedback,
  se: _emscripten_glPixelStorei,
  re: _emscripten_glPolygonOffset,
  qe: _emscripten_glProgramBinary,
  pe: _emscripten_glProgramParameteri,
  oe: _emscripten_glQueryCounterEXT,
  ne: _emscripten_glReadBuffer,
  me: _emscripten_glReadPixels,
  le: _emscripten_glReleaseShaderCompiler,
  ke: _emscripten_glRenderbufferStorage,
  je: _emscripten_glRenderbufferStorageMultisample,
  ie: _emscripten_glResumeTransformFeedback,
  he: _emscripten_glSampleCoverage,
  ge: _emscripten_glSamplerParameterf,
  fe: _emscripten_glSamplerParameterfv,
  ee: _emscripten_glSamplerParameteri,
  de: _emscripten_glSamplerParameteriv,
  ce: _emscripten_glScissor,
  be: _emscripten_glShaderBinary,
  ae: _emscripten_glShaderSource,
  $d: _emscripten_glStencilFunc,
  _d: _emscripten_glStencilFuncSeparate,
  ...
  zd: _emscripten_glUniform2uiv,
  yd: _emscripten_glUniform3f,
  xd: _emscripten_glUniform3fv,
  wd: _emscripten_glUniform3i,
  vd: _emscripten_glUniform3iv,
  ud: _emscripten_glUniform3ui,
  td: _emscripten_glUniform3uiv,
  sd: _emscripten_glUniform4f,
  rd: _emscripten_glUniform4fv,
  qd: _emscripten_glUniform4i,
  pd: _emscripten_glUniform4iv,
  od: _emscripten_glUniform4ui,
  nd: _emscripten_glUniform4uiv,
  md: _emscripten_glUniformBlockBinding,
  ld: _emscripten_glUniformMatrix2fv,
  kd: _emscripten_glUniformMatrix2x3fv,
  jd: _emscripten_glUniformMatrix2x4fv,
  id: _emscripten_glUniformMatrix3fv,
  hd: _emscripten_glUniformMatrix3x2fv,
  gd: _emscripten_glUniformMatrix3x4fv,
  fd: _emscripten_glUniformMatrix4fv,
  ed: _emscripten_glUniformMatrix4x2fv,
  ...
  _c: _emscripten_glVertexAttrib2f,
  ...
  ua: _glCompressedTexImage3D,
  m: _glCompressedTexSubImage2D,
  xc: _glCompressedTexSubImage3D,
  ta: _glCreateProgram,
  O: _glCreateShader,
  wc: _glCullFace,
  sa: _glDeleteBuffers,
  vc: _glDeleteFramebuffers,
  V: _glDeleteProgram,
  l: _glDeleteRenderbuffers,
  C: _glDeleteShader,
  ra: _glDeleteTextures,
  uc: _glDepthFunc,
  tc: _glDepthMask,
  sc: _glDisable,
  ...
  zb: _glfwGetMousePos,
  yb: _glfwGetMouseWheel,
  xb: _glfwGetWindowParam,
  wb: _glfwGetWindowRefreshRate,
  ja: _glfwGetWindowSize,
  vb: _glfwIconifyWindow,
  ub: _glfwInitJS,
  ia: _glfwOpenWindow,
  x: _glfwOpenWindowHint,
  tb: _glfwPollEvents,
  sb: _glfwResetKeyboard,
  rb: _glfwSetCharCallback,
  qb: _glfwSetDeviceChangedCallback,
  pb: _glfwSetGamepadCallback,
  ob: _glfwSetMarkedTextCallback,
  nb: _glfwSetTouchCallback,
  mb: _glfwSetWindowBackgroundColor,
  lb: _glfwSetWindowCloseCallback,
  kb: _glfwSetWindowFocusCallback,
  jb: _glfwSetWindowIconifyCallback,
  ib: _glfwSetWindowSize,
  hb: _glfwSetWindowSizeCallback,
  I: _glfwShowKeyboard,
  gb: _glfwSwapBuffers,
  ...
  f: invoke_viiii,
  q: invoke_viiiii,
  eb: _js_addBusinessEvent,
  db: _js_addDesignEvent,
  cb: _js_addDesignEventWithValue,
  bb: _js_addErrorEvent,
  ab: _js_addProgressionEvent,
  $a: _js_addProgressionEventWithScore,
  _a: _js_addResourceEvent,
  Za: _js_configureAvailableCustomDimensions01,
  Ya: _js_configureAvailableCustomDimensions02,
  Xa: _js_configureAvailableCustomDimensions03,
  Wa: _js_configureAvailableResourceCurrencies,
  Va: _js_configureAvailableResourceItemTypes,
  Ua: _js_configureBuild,
  Ta: _js_configureGameEngineVersion,
  Sa: _js_configureSdkGameEngineVersion,
  Ra: _js_configureUserId,
  Qa: _js_endSession,
  Pa: _js_getRemoteConfigsContentAsString,
  Oa: _js_getRemoteConfigsValueAsStringWithDefaultValue,
  R: _js_initialize,
  Na: _js_isRemoteConfigsReady,
  Ma: _js_setCustomDimension01,
  La: _js_setCustomDimension02,
  Ka: _js_setCustomDimension03,
  fa: _js_setEnabledInfoLog,
  ea: _js_setEnabledVerboseLog,
  da: _js_setEventSubmission,
  Ja: _js_setGlobalCustomEventFields,
  ca: _js_setManualSessionHandling,
  Ia: _js_startSession,
  a: wasmMemory,
  Ba: _strftime
};
...
var _wasm_call_ctors = function ___wasm_call_ctors() {
  return (_wasm_call_ctors = wasmExports["Ci"])();
};
var _dmExportedSymbols = Module["_dmExportedSymbols"] = function () {
  return (_dmExportedSymbols = Module["_dmExportedSymbols"] = wasmExports["Di"])();
};
var _main = Module["_main"] = function (a0, a1) {
  return (_main = Module["_main"] = wasmExports["Ei"])(a0, a1);
};
var _malloc = Module["_malloc"] = function (a0) {
  return (_malloc = Module["_malloc"] = wasmExports["Fi"])(a0);
};
var _free = Module["_free"] = function (a0) {
  return (_free = Module["_free"] = wasmExports["Gi"])(a0);
};
var _js_remote_configs_callback = Module["_js_remote_configs_callback"] = function () {
  return (_js_remote_configs_callback = Module["_js_remote_configs_callback"] = wasmExports["Ii"])();
};
var _htonl2 = function _htonl(a0) {
  return (_htonl2 = wasmExports["Ji"])(a0);
};
var _dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = function (a0) {
  return (_dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = wasmExports["Ki"])(a0);
};
var _dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = function () {
  return (_dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = wasmExports["Li"])();
};
var _setTempRet = function setTempRet0(a0) {
  return (_setTempRet = wasmExports["Mi"])(a0);
};
var _htons2 = function _htons(a0) {
  return (_htons2 = wasmExports["Ni"])(a0);
};
var _ntohs2 = function _ntohs(a0) {
  return (_ntohs2 = wasmExports["Oi"])(a0);
};
var _JSWriteDump = Module["_JSWriteDump"] = function (a0) {
  return (_JSWriteDump = Module["_JSWriteDump"] = wasmExports["Pi"])(a0);
};
var _setThrew2 = function _setThrew(a0, a1) {
  return (_setThrew2 = wasmExports["Qi"])(a0, a1);
};
var _stackSave = function stackSave() {
  return (_stackSave = wasmExports["Ri"])();
};
var _stackRestore = function stackRestore(a0) {
  return (_stackRestore = wasmExports["Si"])(a0);
};
var _stackAlloc = function stackAlloc(a0) {
  return (_stackAlloc = wasmExports["Ti"])(a0);
};
var dynCall_jii = Module["dynCall_jii"] = function (a0, a1, a2) {
  return (dynCall_jii = Module["dynCall_jii"] = wasmExports["Ui"])(a0, a1, a2);
};
var dynCall_ji = Module["dynCall_ji"] = function (a0, a1) {
  return (dynCall_ji = Module["dynCall_ji"] = wasmExports["Vi"])(a0, a1);
};
