!function (n) {
  ...
  function (n, e, t) {
    ...
    function d(n) {
      ...
      w.querySelectorAll('.image').forEach(
        function (n) {
      ...
      g.querySelectorAll('.bullet').forEach(
        function (n, e) {
          n.className = 'bullet',
          e === k &&
          (n.className += ' active')
    ...
    C = window.location.hostname.endsWith('game-cdn.poki.com') ||
  ...
  function (n, e, t) {
    ...
    (
      u = 'https://img.poki-cdn.com/cdn-cgi/image/quality=78,width=40,height=40,fit=cover,g=0.5x0.5,f=auto/'.concat(u.substr(21))
    ),
    d.src = u;
    ...
    */
    ...
    Module.canvas.width = canvasSize.width;
    Module.canvas.height = canvasSize.height;

  // As a default initial behavior, pop up an alert when webgl context is lost. To make your
  // application robust, you may want to override this behavior before shipping!
  // See http://www.khronos.org/registry/webgl/specs/latest/1.0/#5.15.2
  L.addEventListener("webglcontextlost", function(e) { alert('WebGL context lost. You will need to reload the page.'); e.preventDefault(); }, false);
    ...
    n.exports = function (n) {
      ...
      e.i = function (n, t) {
        ...
        for (o = 0; o < n.length; o++) {
          ...
          null != a[0] &&
          i[a[0]] ||
          (t && !a[2] ? a[2] = t : t && (a[2] = '(' + a[2] + ') and (' + t + ')'), e.push(a))
        }
      },
      e
    }
  ...
  function (n, e, t) {
    ...
    function r(n, e) {
      ...
      var i = x[x.length - 1];
      if ('top' === n.insertAt) i ? i.nextSibling ? t.insertBefore(e, i.nextSibling) : t.appendChild(e) : t.insertBefore(e, t.firstChild),
      x.push(e);
       else if ('bottom' === n.insertAt) t.appendChild(e);
       else {
        if ('object' != typeof n.insertAt || !n.insertAt.before) throw new Error(
    ...
    function u(n, e) {
      ...
      if (e.transform && n.css) {
        if (
          !(
            r = 'function' == typeof e.transform ? e.transform(n.css) : e.transform.default(n.css)
          )
        ) return function () {
        };
        n.css = r
    ...
    function m(n, e, t) {
      var i = t.css,
      o = t.sourceMap,
      r = void 0 === e.convertToAbsoluteUrls &&
      o;
      (e.convertToAbsoluteUrls || r) &&
      (i = S(i)),
      o &&
      (
  ...
  function (n, e, t) {
    ...
    function i() {
      ...
      t > w.a.maxRatio ? d.style.width = ''.concat(e * w.a.maxRatio, 'px') : t < w.a.minRatio &&
    ...
    function c() {
      ...
      n.src = ''.concat('', '').concat(w.a.metadata.loader_filename),
      w.a.dataUrl = ''.concat('', '').concat(w.a.metadata.data_filename),
      w.a.frameworkUrl = ''.concat('', '').concat(w.a.metadata.framework_filename),
      w.a.codeUrl = ''.concat('', '').concat(w.a.metadata.code_filename),
      ...
      */
      // window.onGameLoadingFinished = r;
  ...
  function (n, e, t) {
    var i = function (n) {
      ...
      function s(n) {
        function e(i, o, r, a) {
          ...
          if ('throw' !== s.type) {
            ...
            return l &&
            'object' == typeof l &&
            w.call(l, '__await') ? Promise.resolve(l.__await).then(function (n) {
              e('next', n, r, a)
            }, function (n) {
              e('throw', n, r, a)
      ...
      function l(n, e) {
        ...
        if (i === p) {
          if (e.delegate = null, 'throw' === e.method) {
            if (
              n.iterator.return &&
              (e.method = 'return', e.arg = p, l(n, e), 'throw' === e.method)
            ) return I;
            e.method = 'throw',
      ...
      function d(n) {
        ...
        (e.catchLoc = n[1]),
        2 in n &&
        (e.finallyLoc = n[2], e.afterLoc = n[3]),
      ...
      function h(n) {
        if (n) {
          ...
          if (!isNaN(n.length)) {
            var t = - 1,
            i = function e() {
              for (; ++t < n.length; ) if (w.call(n, t)) return e.value = n[t],
              e.done = !1,
              e;
              return e.value = p,
              e.done = !0,
      ...
      n.mark = function (n) {
        return Object.setPrototypeOf ? Object.setPrototypeOf(n, r) : (n.__proto__ = r, x in n || (n[x] = 'GeneratorFunction')),
      ...
      f.prototype = {
        ...
        abrupt: function (n, e) {
          ...
          return r.type = n,
          r.arg = e,
          o ? (this.method = 'next', this.next = o.finallyLoc, I) : this.complete(r)
        },
        complete: function (n, e) {
          if ('throw' === n.type) throw n.arg;
          return 'break' === n.type ||
          'continue' === n.type ? this.next = n.arg : 'return' === n.type ? (
        ...
        finish: function (n) {
          for (var e = this.tryEntries.length - 1; e >= 0; --e) {
            ...
            if (t.finallyLoc === n) return this.complete(t.completion, t.afterLoc),
            u(t),
            I
          }
        },
  ...
  function (n, e) {
    ...
    window.initPokiBridge = function (n) {
      ...
      window.pokiReady ||
      window.pokiAdBlock ? window.pokiReady ? window.unityGame.SendMessage(n, 'ready') : window.pokiAdBlock &&
      window.unityGame.SendMessage(n, 'adblock') : window.pokiBridge = n
    },
    ...
    window.rewardedBreak = function () {
      var n;
      (n = PokiSDK).rewardedBreak.apply(n, arguments).then(
        function (n) {
