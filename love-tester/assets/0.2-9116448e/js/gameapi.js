...
fg_api.prototype.adsModule = function() {
	...
	module.prototype.getAdTagUrl = function(variant, priceMode, customParamsQueryString, sizeString, requestType, adUnit) {
		...
		myAdTagUrl =
					"./gampad/ads?npa=[npa]&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&correlator=[timestamp]&ciu_szs=";
...
fg_api.prototype.apstagModule = function () {
	...
	module.prototype.init = function () {
        ...
        !function(a9,a,p,s,t,A,g){if(a[a9])return;function q(c,r){a[a9]._Q.push([c,r])}a[a9]={init:function(){q("i",arguments)},fetchBids:function(){q("f",arguments)},setDisplayBids:function(){},targetingKeys:function(){return[]},_Q:[]};A=p.createElement(s);A.async=!0;A.src=t;g=p.getElementsByTagName(s)[0];g.parentNode.insertBefore(A,g)}("apstag",window,document,"script","");
...
fg_api.prototype.click2playModule = function() {
	...
	module.prototype.createOverlay = function() {
        M.overlayElements.playBtnContainer = self.createElement("div", {
            class: "fg-click2play" + (M.options.showTeaser ? "" : " fg-click2play-continue") + (detection.is.smartphone ? " smartphone" : ""),
            style: "opacity: 0;transition: opacity 1s;     display: none;"
        }),
        M.overlayElements.gameIcon = self.createElement("div", {
            class: "fg-gameicon",
            title: M.options.title
        ...
        M.status.gameIconLoaded || (void 0 !== self.config.thumb ? M.status.gameIconLoaded = new Promise((function(n, o) {
            ...
            ,
            i.onerror = n,
            i.src = self.config.thumb,
            M.overlayElements.gameIconImage = i
        }
        )) : M.status.gameIconLoaded = PromisM.resolve()),
        M.status.gameIconLoaded.then((function() {}
        )),
        M.options.showTeaser ? (M.status.backgroundLoaded || (void 0 !== self.config.blurred_thumb ? M.status.backgroundLoaded = new Promise((function(n, o) {
            var i = document.createElement("img");
            i.onload = n,
            i.onerror = n,
            i.src = self.config.blurred_thumb,
            M.overlayElements.gameIconImage = i
        }
        )) : M.status.backgroundLoaded = PromisM.resolve()),
        M.status.backgroundLoaded.then((function() {
            // M.overlayElements.branding.style.background = '#000 url("' + self.config.blurred_thumb + '") no-repeat center center';
            // M.overlayElements.branding.style.backgroundSize = "cover"
        }
        ...
        M.overlayElements.playBtn.innerHTML = '<div class="fg-click2play-loading"><span class="fg-click2play-loading-bounce1"></span><span class="fg-click2play-loading-bounce2"></span><span class="fg-click2play-loading-bounce3"></span></div>',
        M.overlayElements.privacyInfo = self.createElement("div", {
            class: "privacy-info"
        }),
        M.overlayElements.privacyInfo.innerHTML = self.translate("api.privacy_info") + self.translate("api.privacy_link"),
        M.overlayElements.stageHeader = self.createElement("div", {
            class: "fg-click2play-stage-header"
        }),
        M.overlayElements.gameDetails = self.createElement("div", {
        ...
        M.overlayElements.gameDetails.appendChild(M.overlayElements.playBtn),
        M.overlayElements.playBtnStage.appendChild(M.overlayElements.stageFooter),
        !M.options.showPolicy || self.consent && self.consent.isPlatformLoaded() || (M.overlayElements.stageFooter.appendChild(M.overlayElements.privacyInfo),
        self.adapters && self.adapters.add("consent", "platformLoaded", (function() {
            M.overlayElements.stageFooter && (faZepto(M.overlayElements.stageFooter).css({
                opacity: "0",
                transition: "opacity 0.5s"
            }),
            setTimeout((function() {
                M.overlayElements.stageFooter && (M.overlayElements.stageFooter.style.visibility = "hidden")
            }
            ), 500))
        }
        )));
        var n = [M.status.gameIconLoaded || Promise.resolve(), M.status.backgroundLoaded || Promise.resolve()];
...
fg_api.prototype.videoadsModule = function() {
	...
	module.prototype.getAdTagUrl = function() {
		...
		// @see https://support.google.com/dfp_premium/answer/1068325?hl=de
		myadTagUrl =
			"./gampad/ads?npa=1&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=[referrer_url]&correlator=[timestamp]&ciu_szs=";
	...
	function loadStylesheet() {
		return new Promise(function (resolve) {
			...
			newStylesheet.setAttribute(
				"href",
				"./assets/0.2-9116448e/css/play.css"
			);
