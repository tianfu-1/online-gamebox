...
gameReadyToStart=true;PokiSDK.gameLoadingFinished();
 top.h5_sdk.showGameLoadingCompleted();
...
function adInterstitialShow(){simpleLogC("adInterstitialShow()");
 top.h5_sdk.showAd('Interstitial');
PokiSDK.commercialBreak().then(()=>{setGameFocus(true);Module.ccall("ad_interstitial_on_showed","v",["number"],[1]);});}
function adRewardedShow(){simpleLogC("adRewardedShow()");pokiEnsureStop();
